...
export default function Home() {
  ...
  const playoffResultOrder = playoffTournament?.format === "external"
    ? ["final", "sf1", "sf2", "qf1", "qf2", "qf3", "qf4", "bronze"]
